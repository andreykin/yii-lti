...
## Usage
* Based on official demo Rating APP, I create some demo controller and components to show you, how it works. It's need to read http://www.spvsoftwareproducts.com/php/rating/ source code to understand PHP LTI library usage. 
* For launch demo you also need some customization in your "user" table: add new varchar(255) fields "lti_user_id" and "auth_service_name";
